...
<i class="fa fa-dashboard" ></i> Panel de Control / Agregar Usuario
...
<label class="col-md-3 control-label">Perfil del usuario: </label>
...
<input type="submit" name="submit" value="Agregar Usuario" class="btn btn-primary form-control">
...
echo "<script>alert('Usuario agregado con etsito')</script>";
